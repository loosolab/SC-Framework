...
def test_log_anndata(adata):
    ...
    # run the function
    adata = test_func(adata, param1=1, param2=None, param3="test", param4=1.0, param5=True, param6={"nested": {"inner": True}})
    ...
    assert "param6" in adata.uns["sctoolbox"]["log"]["test_func"]["run_1"]['kwargs']
