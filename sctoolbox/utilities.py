...
def load_anndata(is_from_previous_note=True, notebook=None, data_to_evaluate=None):
    ...
    def loading_adata(NUM, KEY2):
        pathway=check_infoyml(KEY2)
    ...
    #Messages and others
    KEY="Output_path"
#        The Output_path is a string deposited in a file called "info.yml" from the notebook 1.
#        The Output_path determines were the anndata objected generated by the first notebook was stored.
#        The info.yml will be in same directoriy where the notebook is executed.
    ...
    if is_from_previous_note == True: #Load anndata object from previous notebook
        if isinstance(notebook, int) == False: #Close if the notebook number is not correct
            ...
            file_path=loading_adata(notebook, KEY)
