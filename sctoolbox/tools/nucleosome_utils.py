...
#
#
# def plot_wavelet_transformation(convolution, wavelengths, fld=None, save=False):
#     xmin = 0
...
#         ax1.plot(fld)
#
#         ax2.imshow(convolution, aspect='auto', cmap='jet', extent=[xmin, xmax, ymax, ymin])
#         ax2.colorbar(label='Fit')
